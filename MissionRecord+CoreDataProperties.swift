...
extension MissionRecord {
    ...
    @NSManaged public var verificationText: String?
    @NSManaged public var verificationImage: Data?
...
extension MissionRecord {
    ...
    // 获取已验证的任务记录
    static func predicateForVerified() -> NSPredicate {
        return NSPredicate(format: "isVerified == YES")
    }
}
