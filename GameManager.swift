...
class GameManager: ObservableObject {
    ...
    func completeMissionWithVerification(_ missionType: MissionType, verificationText: String?, verificationImage: UIImage?) -> Bool {
        let success = DefaultMissionSystem.shared.completeMission(
            type: missionType,
    ...
    func getTodayUsageRecords() -> [UsageRecord] {
